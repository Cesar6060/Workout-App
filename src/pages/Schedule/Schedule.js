...
const Schedule = () => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        const newSchedule = {
            chestAndTriceps: { MuscleGroupDay: 'Chest and Triceps', time: chestTime, days: chestDays },
        ...
        try {
            const docRef = await addDoc(scheduleCollection, newSchedule);
        ...
        <Container>
            ...
            <Form onSubmit={handleFormSubmit}>
                <Form.Group controlId="chestTimeRange">
                    <Form.Label><span className="bold-MuscleGroupDay">Chest and Triceps</span></Form.Label>
                ...
                <Form.Group controlId="backTimeRange">
                    <Form.Label><span className="bold-MuscleGroupDay">Back and Biceps</span></Form.Label>
                ...
                <Form.Group controlId="legsTimeRange">
                    <Form.Label><span className="bold-MuscleGroupDay">Legs</span></Form.Label>
                ...
                <Form.Group controlId="shouldersTimeRange">
                    <Form.Label><span className="bold-MuscleGroupDay">Shoulders</span></Form.Label>
                    <Form.Control
                        as="select"
                        size="sm"
                        value={shouldersTime}
...
//         const newSchedule = [
//             { MuscleGroupDay: 'Chest and Triceps', time: chestTime, days: chestDays },
//             { MuscleGroupDay: 'Back and Biceps', time: backTime, days: backDays },
//             { MuscleGroupDay: 'Legs', time: legsTime, days: legsDays },
//             { MuscleGroupDay: 'Shoulders', time: shouldersTime, days: shouldersDays },
//         ];
